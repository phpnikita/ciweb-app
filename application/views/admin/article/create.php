	        ...
	        <div class="row">
	          <div class="col-lg-12">
	            ...
	            <div class="card card-primary">
	              	...
	              	<form name="categoryForm" id="categoryForm" method="post" action="<?= base_url().'admin/article/create'?>" enctype="multipart/form-data">
		              	<div class="card-body">
		              			<div class="form-group">
		              				...
		              				<select name="category_id" id="category_id" class="form-control <?= (form_error('category_id') != "") ? 'is-invalid' : '';?>">
		              					...
		              					?>
		              						<option <?= set_select('category_id',$category['id'],false)?> value="<?= $category['id'];?>"><?= $category['name'];?></option>
		              					<?php
		              							}
		              						}else{
		              					?>
		              			...
		              			<div class="form-group">
		              				...
		              				<textarea class="textarea <?= (form_error('description') != "") ? 'is-invalid' : ''; ?>" name="description"> <?= set_value('description');?></textarea>
		              			...
		              			<div class="form-group">
		              				...
		              				<input type="text" name="author" id="author" class="form-control <?= (form_error('author') != "") ? 'is-invalid' : ''; ?>" value="<?= set_value('author');?>">
		              				<?= form_error('author');?>
		              			</div>
		              			<div class="custom-control custom-radio float-left">
		                          <input class="custom-control-input" type="radio" id="statusActive" name="status" value="1" checked>
